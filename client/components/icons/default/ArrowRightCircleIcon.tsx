    ...
    >
      ...
      >
        <path
          id="Pfad_82"
          data-name="Pfad 82"
          d="M12.978,7.989A4.989,4.989,0,1,1,7.989,3a4.989,4.989,0,0,1,4.989,4.989Z"
        ...
        <path
          id="Pfad_83"
          data-name="Pfad 83"
          d="M18,15.991l2-2-2-2"
          transform="translate(-13.011 -9.007)"
          fill="none"
          stroke="#fff"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        <path
          ...
          data-name="Pfad 84"
          d="M12,18h3.991"
          transform="translate(-9.007 -13.011)"
          fill="none"
          stroke="#fff"
          strokeLinecap="round"
          strokeLinejoin="round"
